...
public class Guis
{
    ...
    public static class UiWidget extends net.minecraft.client.gui.components.AbstractWidget
    {
        ...
        public UiWidget show() { visible = true; return this; }
        public UiWidget hide() { visible = false; return this; }
    ...
    public static class HorizontalProgressBar extends UiWidget
    {
        ...
        public double getProgress() { return progress_; }

        public HorizontalProgressBar setMaxProgress(double progress)
        { progress_max_ = Math.max(progress, 0); return this; }

        public double getMaxProgress() { return progress_max_; }

        public HorizontalProgressBar show() { visible = true; return this; }
        public HorizontalProgressBar hide() { visible = false; return this; }
    ...
    public static class CheckBox extends UiWidget
    {
        ...
        public boolean checked() { return checked_; }
        public CheckBox checked(boolean on) { checked_ = on; return this; }
        public CheckBox onclick(Consumer<CheckBox> action) { on_click_ = action; return this; }
